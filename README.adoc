...
The most recent version, from which this extension has been built, is `1.13.4.Final`
...
`mvn quarkus:add-extension -Dextension="com.github.fmcejudo:quarkus-eureka:0.0.12"`
